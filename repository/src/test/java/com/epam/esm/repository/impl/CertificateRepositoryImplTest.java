...
class CertificateRepositoryImplTest {
    ...
    @Test
    @Order(1)
    public void shouldReturnCorrectListOfCertificatesOnFindAllTest() {
    ...
    @Test
    @Order(3)
    public void shouldReturnCorrectOptionalIfCertificateWasFoundOnFindByIdTest() {
    ...
    @Test
    @Order(4)
    public void shouldThrowEmptyResultDataAccessExceptionIfCertificateWasNotFoundOnFindByIdTest() {
    ...
    public void shouldThrowDataAccessExceptionOnFindByIdTest() {
        doThrow(new DataAccessException("") {})
                .when(mockCertificateRepository)
                        .findById(0L);
        assertThrows(DataAccessException.class,
                () -> mockCertificateRepository.findById(0L));
    }

    @Test
    @Order(6)
    public void shouldReturnCorrectListIfCertificatesWithSuchTagWereFoundOnFindByTagTest() {
        for (int i = 1; i < 5; i++) {
    ...
    @Test
    @Order(7)
    public void shouldReturnEmptyListIfCertificatesWithSuchTagWereNotFoundOnFindByTagTest() {
    ...
    @Test
    @Order(8)
    public void shouldThrowDataAccessExceptionOnFindByTagTest() {
    ...
    @Test
    @Order(9)
    public void shouldReturnCorrectListIfCertificatesWithSuchNameWereFoundOnFindBySearchFilterTest() {
    ...
    @Test
    @Order(10)
    public void shouldReturnEmptyListIfCertificatesWithSuchNameWereNotFoundOnFindBySearchFilterTest() {
        SearchFilter searchFilter =
                RepositoryTestDataFactory.createSearchFilter(
    ...
    @Test
    @Order(11)
    public void shouldReturnCorrectListIfCertificatesWithSuchDescriptionWereFoundOnFindBySearchFilterTest() {
        SearchFilter searchFilter =
                RepositoryTestDataFactory.createSearchFilter(
    ...
    @Test
    @Order(12)
    public void shouldReturnEmptyListIfCertificatesWithSuchDescriptionWereNotFoundOnFindBySearchFilterTest() {
        SearchFilter searchFilter =
                RepositoryTestDataFactory.createSearchFilter(
    ...
    @Test
    @Order(13)
    public void shouldThrowDataAccessExceptionFindBySearchFilterTest() {
        SearchFilter searchFilter =
                RepositoryTestDataFactory.createSearchFilter(
    ...
    @Test
    @Order(14)
    public void shouldReturnCorrectListOfCertificatesSortedByNameAscendingTest() {
    ...
    @Test
    @Order(15)
    public void shouldReturnCorrectListOfCertificatesSortedByNameDescendingTest() {
        SortFilter sortFilter =
                RepositoryTestDataFactory.createSortFilter(
    ...
    @Test
    @Order(16)
    public void shouldReturnCorrectListOfCertificatesSortedByCreateDateAscendingTest() {
        SortFilter sortFilter =
                RepositoryTestDataFactory.createSortFilter(
    ...
    @Test
    @Order(17)
    public void shouldReturnCorrectListOfCertificatesSortedByCreateDateDescendingTest() {
        SortFilter sortFilter =
                RepositoryTestDataFactory.createSortFilter(
    ...
    @Test
    @Order(18)
    public void shouldReturnCorrectListOfCertificatesSortedByLastUpdateDateAscendingTest() {
        SortFilter sortFilter =
                RepositoryTestDataFactory.createSortFilter(
    ...
    @Test
    @Order(19)
    public void shouldReturnCorrectListOfCertificatesSortedByLastUpdateDateDescendingTest() {
        SortFilter sortFilter =
                RepositoryTestDataFactory.createSortFilter(
    ...
    @Test
    @Order(20)
    public void shouldThrowDataAccessExceptionOnFindBySortFilterTest() {
        SortFilter sortFilter =
                RepositoryTestDataFactory.createSortFilter(
                        SortType.NAME, SortOrder.ASC);
    ...
    @Test
    @Order(24)
    public void shouldUpdateOnlyNotNullCertificateFieldsTest() {
        Optional<Certificate> optionalCertificate =
    ...
    @Test
    @Order(25)
    public void shouldNotUpdateIfAllCertificateFieldsAreNullTest() {
    ...
    @Test
    @Order(26)
    public void shouldThrowDataAccessExceptionOnUpdateTest() {
        Certificate certificate =
                RepositoryTestDataFactory.createCertificate(
                        "some name", "some description");
    ...
    @Test
    @Order(27)
    public void shouldNotThrowAnythingIfTagsWereInsertedTest() {
        Optional<Certificate> optionalCertificate =
                certificateRepository.findById(5L);
        assertTrue(optionalCertificate.isPresent());
    ...
    @Test
    @Order(28)
    public void shouldThrowDataAccessExceptionIfNullObjectsAreInsertedTest() {
        Optional<Certificate> optionalCertificate =
                certificateRepository.findById(5L);
        assertTrue(optionalCertificate.isPresent());
    ...
    @Test
    @Order(29)
    public void shouldThrowDataAccessExceptionOnInsertTagsTest() {
        Certificate certificate =
                RepositoryTestDataFactory.createCertificate(
                        "some name", "some description");
    ...
    @Test
    @Order(30)
    public void shouldNotThrowAnythingIfCertificateWasDeletedTest() {
        int size = certificateRepository.findAll().size();
    ...
    public void shouldThrowDataAccessExceptionOnDeleteTest() {
        doThrow(new DataAccessException("") {})
                .when(mockCertificateRepository)
                        .delete(0L);
        assertThrows(DataAccessException.class,
                () -> mockCertificateRepository.delete(0L));
    }
}