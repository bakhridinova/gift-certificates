...
public class CertificateControllerTest {
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificatesWereNotFoundOnGetAllTest()
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificateWasNotFoundOnGetByIdTest()
            throws NotFoundException {
        doThrow(NotFoundException.class)
                .when(certificateService)
                .findById(0L);
    ...
    @Test
    public void shouldReturnResponseWithCorrectCertificateIfNoExceptionWasThrownOnGetByIdTest()
            throws NotFoundException {
        CertificateDTO certificateDTO =
                ControllerTestDataFactory.createCertificateDTO();
    ...
    @Test
    public void shouldThrowInvalidRequestBodyExceptionIfFieldErrorsArePresentOnGetByTagTest() {
        TagDTO tagDTO =
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificatesWereNotFoundOnGetByTagTest()
            throws NotFoundException {
        TagDTO tagDTO =
                ControllerTestDataFactory.createTagDTO();
    ...
    @Test
    public void shouldReturnResponseWithCorrectListIfNoExceptionWasThrownOnGetByTagTest()
    ...
    @Test
    public void shouldThrowInvalidRequestBodyExceptionIfFieldErrorsArePresentOnGetBySearchFilterTest() {
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificatesWereNotFoundOnGetBySearchFilterTest()
            throws NotFoundException {
        SearchFilterDTO invalidSearchFilterDTO =
                ControllerTestDataFactory.createInvalidSearchFilterDTO();
    ...
    @Test public  void shouldReturnResponseWithCorrectListIfNoExceptionWasThrownOnGetBySearchFilterTest()
            throws NotFoundException, InvalidRequestBodyException {
        SearchFilterDTO invalidSearchFilterDTO =
                ControllerTestDataFactory.createInvalidSearchFilterDTO();
        CertificateDTO certificateDTO =
    ...
    @Test
    public void shouldThrowInvalidRequestBodyExceptionIfFieldErrorsArePresentOnGetBySortFilterTest() {
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificatesWereNotFoundOnGetBySortFilterTest()
            throws NotFoundException {
        SortFilterDTO invalidSortFilterDTO =
                ControllerTestDataFactory.createInvalidSortFilterDTO();
    ...
    @Test
    public void shouldReturnResponseWithCorrectListIfNoExceptionWasThrownOnGetBySortFilterTest()
            throws NotFoundException, InvalidRequestBodyException {
        SortFilterDTO invalidSortFilterDTO =
                ControllerTestDataFactory.createInvalidSortFilterDTO();
        CertificateDTO certificateDTO =
    ...
    @Test
    public void shouldThrowInvalidRequestBodyExceptionIfFieldErrorsArePresentOnEditTest() {
        CertificateDTO certificateDTO =
                ControllerTestDataFactory.createCertificateDTO();
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificateWasNotFoundOnEditTest()
    ...
    @Test
    public void shouldThrowModificationExceptionIfExceptionWasThrownOnEditTest()
            throws NotFoundException, ModificationException {
        CertificateDTO certificateDTO =
                ControllerTestDataFactory.createCertificateDTO();
    ...
    @Test
    public void shouldReturnResponseWithCorrectStatusIfNoExceptionWasThrownOnEditTest()
    ...
    @Test
    public void shouldThrowNotFoundExceptionIfCertificateWasNotFoundOnDeleteByIdTest()
            throws NotFoundException, ModificationException {
        doThrow(NotFoundException.class)
                .when(certificateService)
                        .delete(0L);
    ...
    @Test
    public void shouldThrowModificationExceptionIfExceptionWasThrownOnDeleteByIdTest()
            throws NotFoundException, ModificationException {
        doThrow(ModificationException.class)
                .when(certificateService)
                        .delete(0L);
    ...
    @Test
    public void shouldReturnResponseWithCorrectStatusIfNoExceptionWasThrownOnDeleteByIdTest()
            throws NotFoundException, ModificationException {
        doNothing()
                .when(certificateService)
                        .delete(0L);
